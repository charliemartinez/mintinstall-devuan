...
echo "Se ha instalado el repositorio y clave de Quirinux,"
echo "y se ha modificado APT pinning para que sólo permita"
echo "la instalación del Centro de Software mintinstal,"
echo "en versión modificada para Devuan por Charlie Martínez."
echo ""
echo "Puedes instalar mintinstall con:"
echo "    apt install --no-install-recommends mintinstall"
echo ""
